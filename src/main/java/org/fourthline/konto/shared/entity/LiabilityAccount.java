...
@Entity
@Table(name = "LIABILITY_ACCOUNT")
public class LiabilityAccount extends Account {

    public LiabilityAccount() {
    }

    public LiabilityAccount(String name, Long monetaryUnitId) {
        super(name, monetaryUnitId);
    }

    public LiabilityAccount(String name, Long monetaryUnitId, Date effectiveOn, BigDecimal initialBalance) {
