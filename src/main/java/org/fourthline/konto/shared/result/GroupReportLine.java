 ...
 */
public class GroupReportLine extends ReportLine<AccountReportLine> {
    ...
    public GroupReportLine(AccountGroup group, MonetaryAmount amount) {
        super(group.getName(), amount);
        this.group = group;
    }
