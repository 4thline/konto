 ...
 */
public class CurrencyPairModified extends Event<CurrencyPairModified.Handler> {
    ...
    public CurrencyPairModified(CurrencyPair pair) {
        this.pair = pair;
    }
    ...
    protected void dispatch(Handler handler) {
        handler.onCurrencyPairModified(this);
    }
}
