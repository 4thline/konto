...
public interface SettingsService extends RemoteService {
    ...
    Settings<GlobalOption> getGlobalSettings();

    Settings<AccountOption> getAccountSettings(Long accountId);

    void store(Settings<Option> settings) throws ValidationException;

    void remove(Settings<Option> settings);
}
