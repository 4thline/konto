 ...
 */
public class AccountGroupSelectView extends PopupSelectViewImpl<AccountGroupSuggestion> {

    @Inject
    public AccountGroupSelectView() {
        super(500, 200, 150);
    }

    @Override
    protected String getSelectLabel() {
        return Constants.LABEL_SELECT_ACCOUNT_GROUP;
    }
