 ...
 */
public class AccountSelectionModeChange extends Event<AccountSelectionModeChange.Handler> {
    ...
    public AccountSelectionModeChange() {
    }

    public AccountSelectionModeChange(AccountTreeSelectView.Option[] options) {
        this.options = options;
    }

    public AccountSelectionModeChange(AccountTreeSelectView.Option[] options, AccountsQueryCriteria[] preselectedAccounts) {
        this.options = options;
    ...
    public AccountsQueryCriteria[] getPreselectedAccounts() {
    ...
    protected void dispatch(Handler handler) {
        handler.onSelectionModeChange(this);
    }
}
